...
- [x] 6-1. シミュレーターで動作確認する（動画追加・削除・並び替え）
- [x] 6-2. シミュレーターで通知動作を確認する
- [x] 6-3. アプリ再起動後もデータが保持されていることを確認する
- [x] 6-4. 不正URLのバリデーションが正しく動作することを確認する
- [x] 6-5. 動画タップでInstagram / YouTube / Safariが開くことを確認する
